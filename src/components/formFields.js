    ...
    render() {
        ...
        return (
            <div className={`${className} form-button`}>
                <button className={`form-button__button ${grey ? 'form-button__gray-button' : ''}`} type={type} {...input} onClick={onClick}>{title}</button>
            </div>
        )
    }
}
    ...
    render() {
        ...
        return (
            <div className={`${className} form-button-long-grey`}>
                ...
                <button className={`form-button-long-grey__button`} type={type} {...input} onClick={onClick}>{title}</button>
            </div>
        )
    }
}