...
class PurchaseDetail extends Component {
    render() {
        ...
        <div className={`${className} purchase-detail`}>
           ...
           <PurchaseDetailLabel className='purchase-deatil__order-date' title='Order Date' value={orderDate} />
           <PurchaseDetailLabel className='purchase-deatil__shipping' title='Shipping Address' value={`${name}\n ${shippingAddress}`} />
           <PurchaseDetailLabel className='purchase-deatil__total' title='Total' value={total} />
           <PurchaseDetailLabel className='purchase-deatil__credit-card' title='Credit Card' value={creditCard} />
        </div>
        )
    }
}
